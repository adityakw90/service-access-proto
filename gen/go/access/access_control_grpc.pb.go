...
const (
	AccessControlService_CheckAccess_FullMethodName      = "/access.AccessControlService/CheckAccess"
	AccessControlService_AssignRole_FullMethodName       = "/access.AccessControlService/AssignRole"
	AccessControlService_RevokeRole_FullMethodName       = "/access.AccessControlService/RevokeRole"
	AccessControlService_ListSubjectRoles_FullMethodName = "/access.AccessControlService/ListSubjectRoles"
)
...
func (c *accessControlServiceClient) ListSubjectRoles(ctx context.Context, in *ListSubjectRolesRequest, opts ...grpc.CallOption) (*ListSubjectRolesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListSubjectRolesResponse)
	err := c.cc.Invoke(ctx, AccessControlService_ListSubjectRoles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccessControlService_AssignRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AssignRoleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccessControlServiceServer).AssignRole(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccessControlService_AssignRole_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccessControlServiceServer).AssignRole(ctx, req.(*AssignRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AccessControlService_RevokeRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeRoleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccessControlServiceServer).RevokeRole(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccessControlService_RevokeRole_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccessControlServiceServer).RevokeRole(ctx, req.(*RevokeRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AccessControlService_ListSubjectRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSubjectRolesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccessControlServiceServer).ListSubjectRoles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccessControlService_ListSubjectRoles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccessControlServiceServer).ListSubjectRoles(ctx, req.(*ListSubjectRolesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccessControlService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "access.AccessControlService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AccessControlService_AssignRole_Handler,
		},
		{
			MethodName: "RevokeRole",
			Handler:    _AccessControlService_RevokeRole_Handler,
		},
		{
			MethodName: "ListSubjectRoles",
			Handler:    _AccessControlService_ListSubjectRoles_Handler,
		},
	},
